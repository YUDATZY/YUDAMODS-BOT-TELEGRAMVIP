...
console.log('	');
console.log('HTTPS/2 Floodv5 (HTTPS Only) | Method by YudaMods '.green.bold);
console.log('	');
console.log('Usage: node ddos.js <GET/HEAD> <host> <proxies> <duration> <rate<64> <thread(1-3)>	');
process.exit(0);
}
...
console.log('	Attacking | Method-v5 By YudaMods');
setTimeout(() => {
